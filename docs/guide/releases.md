...
1. 打开 [Releases](https://github.com/programbox/programbox/releases)
...
推送以 `v` 开头的标签（`v*.*.*`）会触发 [.github/workflows/release.yml](https://github.com/programbox/programbox/blob/main/.github/workflows/release.yml)：
...
- **CI**：推送/PR 到 `main`/`master`/`develop` 时执行 `dotnet build`
